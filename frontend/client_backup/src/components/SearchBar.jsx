  ...
  useEffect(() => {
    ...
    const timeoutId = setTimeout(async () => {
      ...
      try {
        ...
        // Search tags (get all posts and filter by tags)
      ...
      <div className="relative">
        {isOpen ? (
          ...
          <button
            ...
            className="p-2 rounded-xl hover:bg-neutral-100 dark:hover:bg-neutral-800 text-neutral-600 dark:text-neutral-400 transition-all duration-200"
          >
          ...
          >
            {loading ? (
              <div className="p-8 text-center">
                <svg className="w-8 h-8 animate-spin mx-auto text-purple-600" viewBox="0 0 24 24" fill="none">
              ...
              <div className="max-h-96 overflow-y-auto">
                ...
                {searchResults.users.length > 0 && (
                  <div className="p-3">
                    <h3 className="text-xs font-semibold text-neutral-500 dark:text-neutral-400 uppercase mb-2 px-2">
                      Users
                    </h3>
                    {searchResults.users.map((user) => (
                      <button
                        ...
                        className="w-full flex items-center gap-3 p-2 rounded-xl hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors"
                      >
                        {user.avatarUrl ? (
                  ...
                  <div className="p-3 border-t border-neutral-200 dark:border-neutral-800">
                    ...
                    {searchResults.tags.map((tag, index) => (
                      ...
                      >
                        ...
                        <p className="font-semibold text-neutral-900 dark:text-white text-sm">#{tag}</p>
                      </button>
                    ))}
                  </div>
                )}
