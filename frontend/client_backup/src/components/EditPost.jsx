    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <motion.div
          ...
          className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-3xl shadow-2xl border border-purple-200/50 dark:border-purple-900/50 bg-white dark:bg-[#0f1c2e] overflow-hidden"
          role="dialog"
          aria-modal="true"
          aria-labelledby="edit-post-title"
        >
          {/* Glow effect */}
          <div className="absolute bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-3xl blur-md opacity-20 pointer-events-none -z-10"></div>

          {/* Header */}
          <div className="sticky top-0 z-10 px-6 py-5 bg-white/95 dark:bg-[#0f1c2e]/95 backdrop-blur-xl border-b border-neutral-200 dark:border-neutral-800/50 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 id="edit-post-title" className="text-xl font-bold text-neutral-900 dark:text-white">
                  Edit Post
                </h2>
            ...
            <button
              onClick={onClose}
              className="p-2 rounded-xl hover:bg-neutral-100 dark:hover:bg-neutral-800 text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500"
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="space-y-2">
              <label htmlFor="caption" className="block text-sm font-semibold text-neutral-700 dark:text-neutral-300 flex items-center gap-2 select-none">
            ...
            <div className="space-y-3">
                  ...
                  {tags.map(t => (
                    ...
                    >
                      ...
                      <button
                        type="button"
                        onClick={() => removeTag(t)}
                        className="text-purple-500 hover:text-purple-700 dark:text-purple-400 dark:hover:text-purple-200 transition-colors focus:outline-none focus:ring-2 focus:ring-purple-400 rounded"
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2.5 rounded-xl bg-purple-100 dark:bg-purple-950/30 hover:bg-purple-200 dark:hover:bg-purple-900/50 text-purple-700 dark:text-purple-300 font-medium text-sm border border-purple-200 dark:border-purple-800/50 transition-all duration-300 flex items-center gap-1.5 focus:outline-none focus:ring-2 focus:ring-purple-400"
                  aria-label="Add tag"
                >
            ...
            <div className="space-y-4">
                ...
                <div className="relative group">
                  ...
                  <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 rounded-2xl transition-opacity duration-300 flex items-center justify-center gap-3">
                    <button
                      ...
                      className="p-3 bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-lg transition-all duration-200 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    <button
                      ...
                      className="p-3 bg-red-500 hover:bg-red-600 text-white rounded-full shadow-lg transition-all duration-200 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-red-500"
              ...
              <div>
                ...
                <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-2 text-center select-none">
                  PNG, JPG up to 5MB
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-neutral-200 dark:border-neutral-800/50">
              ...
              <button
                ...
                onClick={onClose}
                disabled={loading}
                className="px-6 py-3.5 rounded-xl bg-white dark:bg-[#1a1f3a] text-neutral-700 dark:text-neutral-200 font-semibold border-2 border-neutral-300 dark:border-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-900/50 transition-all duration-300 hover:scale-105 active:scale-95 shadow-md disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2 select-none focus:outline-none focus:ring-2 focus:ring-purple-500"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                </svg>
